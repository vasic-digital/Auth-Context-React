# CONSTITUTION — Auth-Context-React

Project-specific governance for the **Auth-Context-React** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
